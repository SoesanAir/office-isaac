...
const departments = [
  // -- DPT-001 Open Office (core chapter 1) ----------------------------------
  {
    ...
    floors: ['FLOOR-OPEN-OFFICE-1', 'FLOOR-OPEN-OFFICE-2'],
    ...
    presentation: {
      ...
      music: 'MUS-OPEN-OFFICE',
      ambience: 'SFX-AMB-OPEN-OFFICE',
      transitionSting: 'SFX-STING-OPEN-OFFICE',
    },
  ...
  // -- DPT-003 Operations (core chapter 3) -----------------------------------
  {
    ...
    floors: ['FLOOR-OPERATIONS-1', 'FLOOR-OPERATIONS-2'],
    ...
    presentation: {
      ...
      ambience: 'SFX-AMB-OPERATIONS',
      transitionSting: 'SFX-STING-OPERATIONS',
    },
    narrativeImplication:
  ...
  // -- DPT-004 Executive (core chapter 4) ------------------------------------
  {
    ...
    floors: ['FLOOR-EXECUTIVE-1', 'FLOOR-EXECUTIVE-2'],
    ...
    presentation: {
      ...
      music: 'MUS-EXECUTIVE',
      ambience: 'SFX-AMB-EXECUTIVE',
      transitionSting: 'SFX-STING-EXECUTIVE',
    },
    narrativeImplication:
  ...
  // -- DPT-005 Finance (unlockable alternate chapter 3) ----------------------
  {
    ...
    floors: ['FLOOR-FINANCE-1', 'FLOOR-FINANCE-2'],
    ...
    presentation: {
      ...
      music: 'MUS-FINANCE',
      ambience: 'SFX-AMB-FINANCE',
      transitionSting: 'SFX-STING-FINANCE',
    },
    narrativeImplication:
  ...
  // -- DPT-006 Marketing (unlockable alternate chapter 3) --------------------
  {
    ...
    tag: 'MARKETING',
    routeRole: 'Unlockable alternate chapter 3',
    floors: ['FLOOR-MARKETING-1', 'FLOOR-MARKETING-2'],
    ...
    presentation: {
      ...
      music: 'MUS-MARKETING',
      ambience: 'SFX-AMB-MARKETING',
      transitionSting: 'SFX-STING-MARKETING',
    },
    narrativeImplication:
  ...
  // -- DPT-007 Legal and Compliance (unlockable alternate chapter 4) ---------
  {
    ...
    floors: ['FLOOR-LEGAL-1', 'FLOOR-LEGAL-2'],
    ...
    presentation: {
      ...
      music: 'MUS-LEGAL',
      ambience: 'SFX-AMB-LEGAL',
      transitionSting: 'SFX-STING-LEGAL',
    },
    narrativeImplication:
  ...
  // hint that it exists.
  {
    ...
    presentation: {
      ...
      ambience: 'SFX-AMB-FACILITIES',
      transitionSting: 'SFX-STING-FACILITIES',
    },
    narrativeImplication:
  ...
  // -- DPT-009 Research and Development (secret branch) ----------------------
  {
    ...
    presentation: {
      ...
      music: 'MUS-RND',
      ambience: 'SFX-AMB-RND',
      transitionSting: 'SFX-STING-RND',
    },
    narrativeImplication:
  ...
  // -- DPT-010 The Board (hidden post-CEO chapter) ---------------------------
  {
    ...
    floors: ['FLOOR-BOARD-1', 'FLOOR-BOARD-2'],
    ...
    presentation: {
      ...
      music: 'MUS-BOARD',
      ambience: 'SFX-AMB-BOARD',
      transitionSting: 'SFX-STING-BOARD',
    },
    narrativeImplication:
  ...
  // -- DPT-011 Parent Company (deep hidden chapter) --------------------------
  {
    ...
    presentation: {
      ...
      music: 'MUS-PARENT-COMPANY',
      ambience: 'SFX-AMB-PARENT-COMPANY',
      transitionSting: 'SFX-STING-PARENT-COMPANY',
    },
    narrativeImplication:
  ...
  // -- DPT-012 The Conglomerate (ultra hidden chapter) ----------------------
  {
    ...
    presentation: {
      ...
      ambience: 'SFX-AMB-CONGLOMERATE',
      transitionSting: 'SFX-STING-CONGLOMERATE',
    },
    narrativeImplication:
  ...
  // -- DPT-013 Ownership (terminal hidden arena) ----------------------------
  {
    ...
    presentation: {
      ...
      music: 'MUS-OWNERSHIP',
      ambience: 'SFX-AMB-OWNERSHIP',
      transitionSting: 'SFX-STING-OWNERSHIP',
    },
    narrativeImplication:
